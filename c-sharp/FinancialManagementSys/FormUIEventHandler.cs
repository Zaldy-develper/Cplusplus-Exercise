                                ...
                                bool useWildcards = false)
        {
            ...
            try
            {
                ...
                if (grid.Columns["ACTIVITYTYPE"] != null)
                {
                    ...
                    GridViewColumnHelper.SetFixedColumnWidth(grid, "ACTIVITYTYPE", 275);
                }
                if (grid.Columns["AMOUNT"] != null)
                {
                    ...
                    grid.Columns["AMOUNT"].DefaultCellStyle.Format = "#,##0.00"; // Formats as integer with thousand separators
                    GridViewColumnHelper.SetFixedColumnWidth(grid, "AMOUNT", 105);
                }
