namespace Ipv4SocketCommunication
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            serverText.Enter += serverText_Enter;
            serverText.Leave += serverText_Leave;
            // 
            // btnSend
            // 
            btnSend.Enabled = false;
            btnSend.FlatStyle = FlatStyle.Popup;
            btnSend.Font = new Font("Segoe UI Semibold", 14.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnSend.Location = new Point(377, 278);
            ...
            MaximizeBox = false;
            MaximumSize = new Size(816, 362);
            MinimizeBox = false;
            MinimumSize = new Size(816, 362);
            Name = "Form1";
