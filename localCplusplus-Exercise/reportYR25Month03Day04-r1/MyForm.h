...
namespace Project2ITProcessCommSocket {
	...
	private:
		void StartServerThread() {
			...
			socketHandlerInstance->StartServer(textboxStatus, textboxFilepath);
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnCancel->Location = System::Drawing::Point(474, 37);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(30, 27);
...
#pragma endregion
	...
	private: System::Void btnSend_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		// Create an instance of your modal dialog form.
		...
		if (selectionForm->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
			...
			if (selectedIndex >= 0) {
				int selectedSocket = socketHandlerInstance->ClientSockets[selectedIndex];
